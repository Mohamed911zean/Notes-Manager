...
import { Mail, Lock, UserPlus, Palette } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground px-4 py-12">
      ...
      >
        ...
        >
          ...
          <h1 className="text-4xl font-bold mb-2 text-brand-gradient">Create Account</h1>
          <p className="text-muted-foreground text-sm">Join us and start organizing your life</p>
        </motion.div>
